...
const TopRatedProduct = () => {
    return (
        <div className='w-10/12 mx-auto my-6'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:gap-4 gap-12 mb-10'>
                <div className='p-4 rounded-2xl shadow-xl'>
                    <img src={img1} alt="" />
                    <div>
                        <h2 className='md:text-2xl text-xl font-bold text-gray-800 mt-2'>NEW GENERATION SMART LED TV PRODUCTS</h2>
                ...
                <div className='p-4 rounded-2xl shadow-xl'>
                    <img src={img2} alt="" />
                    <div>
                        <h2 className='md:text-2xl text-xl font-bold text-gray-800 mt-2'>SUPER MIXER GRINDER COLLECTION</h2>
                        <p className='flex space-x-1 my-2 text-yellow-400'><FaStar/><FaStar/><FaStar/><FaStar/><FaStar/></p>
                        <button className='flex items-center font-bold text-gray-700'>Check Now <IoIosArrowDroprightCircle className='text-lightred'></IoIosArrowDroprightCircle></button>
                    </div>
                </div>
                <div className='p-4 rounded-2xl shadow-xl'>
                    <img src={img3} alt="" />
                    <div>
                        <h2 className='md:text-2xl text-xl font-bold text-gray-800 mt-2'>IMPORTED REFRIGERATOR COLLECTION</h2>
                        <p className='flex space-x-1 my-2 text-yellow-400'><FaStar/><FaStar/><FaStar/><FaStar/><FaStar/></p>
                        <button className='flex items-center font-bold text-gray-700'>Check Now <IoIosArrowDroprightCircle className='text-lightred'></IoIosArrowDroprightCircle></button>
                    </div>
                </div>
